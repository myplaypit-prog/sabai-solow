...
export const TOURS: Tour[] = [
  { id: 'elephant', name: '코끼리 목욕', cities: ['chiangmai', 'khaosok'], photo: 'elephant', photo2: 'elephant2', duration: '반나절 · 하루', priceBand: '약 1,500~2,500바트(임시)', noRiding: true,
  ...
  { id: 'cooking', name: '쿠킹클래스', cities: ['chiangmai', 'pai', 'chiangrai'], photo: 'cooking', photo2: 'thaifood', duration: '반나절 · 하루', priceBand: '약 1,000~1,800바트(임시)',
  ...
  { id: 'zipline', name: '짚라인', cities: ['chiangmai'], photo: 'zipline', photo2: 'trek', duration: '2~4시간', priceBand: '약 1,800~4,000바트(임시)',
  ...
  { id: 'trekking', name: '트레킹', cities: ['chiangmai', 'chiangrai', 'pai', 'maehongson', 'khaosok'], photo: 'trek', photo2: 'rice', duration: '반나절 ~ 1박 2일', priceBand: '약 1,000~2,500바트(임시)',
